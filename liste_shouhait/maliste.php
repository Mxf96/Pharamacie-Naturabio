    ...
    <div class="content maliste icone-liste">
        <div class="listeCell">
            ...
            if (isset($_SESSION['id_utilisateur'])) {
                ...
                echo '<a href="/connexion/login.php" class="btn btn-primary">Se connecter pour voir ma liste</a>';
            }
            ?>
        </div>
    </div>
    <script src="https://code.jquery.com/jquery-3.6.0.min.js"></script>
    <script src="/liste_shouhait/list.js"></script> <!-- Inclure le fichier JavaScript externe -->
</main>
